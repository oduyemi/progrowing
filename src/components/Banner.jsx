    ...
    return(
        <>
            <div className="banner  mt-5 w-full md-1/3 px-7 mx-auto relative flex items-stretch justify-between">
                ...
                <h1 className="pl-4 mt-5 font-light text-5xl lg:pl-8">Find a <span><h1 className="emphasis" id="emp_">mentor</h1></span> to help you</h1>
                    <p id="introSubTitle" className="mt-1 pl-6 lg:pl-8 text-gray-400 py-1 text-xxl animate__animated animate__fadeIn animated__delay__4 animate-pulse">Start now. Become a better programmer</p>
                    <div className="btn-container pl-5">
                        <p className="pl-0 lg:pl-4 mt-5 text-2xl font-light">Find world-class mentors <br/>for live mentorship and freelance projects.</p>
